...
List<TextfieldType> registerTextfieldTypes=[TextfieldType.userName,TextfieldType.phone,TextfieldType.email,TextfieldType.password];
  ...
  Row alreadyHaveAccountRow() {
    return Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: (){},
                child: Text(TextUtil.login,style: const TextStyle(fontSize: 16, color: SurfaceColors.ON_PRIMARY_COLOR),textAlign: TextAlign.left),
              )
            ],
          );
  }
    ...
    return SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  padding: index != registerTextfieldTypes.length-1 ? EdgeInsets.only(bottom: dynamicHeight(context, 36)) : EdgeInsets.zero,
                  child: CustomTextfield(
                    textController: TextEditingController(),
                    type: registerTextfieldTypes[index],
                  ),
                );
              },
            ),
